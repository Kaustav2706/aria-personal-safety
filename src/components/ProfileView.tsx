...
import { Camera, Edit2, BrainCircuit, Globe, BellRing, Users, Database, LogOut, ShieldCheck, Sun, Moon } from 'lucide-react';
      ...
      <section className="flex flex-col items-center mb-8">
        ...
        {isEditing ? (
          ...
          <div className="text-center animate-in fade-in duration-300">
            ...
            <p className="text-body-sm text-on-surface-variant opacity-75 mt-0.5 select-none">{profile.email}</p>
          </div>
        )}
      </section>
